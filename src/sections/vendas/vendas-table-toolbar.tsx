...
import type { IVendasTableFilters } from 'src/types/vendas';
...
type Props = {
  dateError: boolean;
  onResetPage: () => void;
  filters: UseSetStateReturn<IVendasTableFilters>;
  options: {
    services: string[];
  };
};

export function VendasTableToolbar({ filters, options, dateError, onResetPage }: Props) {
    ...
    <>
      ...
      >
        <FormControl sx={{ flexShrink: 0, width: { xs: 1, md: 180 } }}>
          <InputLabel htmlFor="filter-service-select">Filtrar por</InputLabel>
        ...
        >
          <TextField
            ...
            placeholder="Pesquisar número ou nome do cliente"
            slotProps={{
              input: {
                startAdornment: (
