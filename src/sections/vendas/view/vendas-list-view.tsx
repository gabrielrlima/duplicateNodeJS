...
import { _vendas, VENDAS_SERVICE_OPTIONS } from 'src/_mock/_vendas';
...
export function VendasListView() {
  ...
  return (
    <>
      <DashboardContent>
        <CustomBreadcrumbs
          heading="Minhas vendas"
          links={[
            { name: 'Dashboard', href: paths.dashboard.root },
            { name: 'Vendas', href: paths.dashboard.vendas?.root || '/dashboard/vendas' },
            { name: 'Minhas vendas' },
          ]}
          action={
            <Button
              component={RouterLink}
              href={paths.dashboard.vendas?.new || '/dashboard/vendas/new'}
              variant="contained"
        ...
        <Card>
          ...
          <VendasTableToolbar
            ...
            options={{ services: VENDAS_SERVICE_OPTIONS.map((option) => option.name) }}
          />
            ...
            <Scrollbar sx={{ minHeight: 444 }}>
              <Table size={table.dense ? 'small' : 'medium'} sx={{ minWidth: 800 }}>
                ...
                <TableBody>
                  {dataFiltered
                    ...
                    .map((row) => (
                      <VendasTableRow
                        ...
                        editHref={
                          paths.dashboard.vendas?.edit?.(row.id) ||
                          `/dashboard/vendas/${row.id}/edit`
                        }
                        detailsHref={
                  ...
                  <TableNoData
                    notFound={notFound}
                    title="Nenhuma opção para o filtro selecionado"
                  />
                </TableBody>
              </Table>
            </Scrollbar>
