...
export function HomeHero({ sx, ...other }: BoxProps) {
  ...
  const renderText = () => (
    <m.div {...motionProps}>
      ...
      >
        Controle imóveis, leads, vendas e o financeiro, tudo em um só lugar. Com o Duplicate, você
        vende, cobra, recebe, paga e comissiona direto da plataforma
      </Typography>
    </m.div>
  );
  ...
  const renderRatings = () => (
    <m.div {...motionProps}>
      ...
      >
        ...
        +R$ 2 milhões em transações gerenciadas
      </Box>
    </m.div>
  );
      ...
      <m.div {...motionProps}>
        <Stack spacing={2.5} sx={{ alignItems: 'center' }}>
          <Button
            ...
            size="large"
            variant="contained"
            startIcon={<Iconify width={24} icon="icon-park-outline:loading-one" />}
          >
            <span>Comece grátis por 14 dias</span>
          </Button>
        </Stack>
      </m.div>
    </Box>
    ...
    >
      ...
      >
        ...
        >
          ...
          <m.div style={{ y: y4 }}>{renderButton()}</m.div>
        </Container>
