...
export function HomeIntegrations({ sx, ...other }: BoxProps) {
  const renderDescription = () => (
    <SectionTitle
      caption="Integrações"
      title="Ecossistema conectado para sua imobiliária"
      description={
        <Box component="span" sx={{ mb: 1, display: 'block' }}>
          Conecte o Duplicate às principais ferramentas do mercado e amplie o potencial da sua
          operação. CRM, automações, gestão de leads, documentos e muito mais, tudo em um só lugar.
        </Box>
      }
