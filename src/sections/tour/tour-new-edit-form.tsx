...
export const NewTourSchema = zod
  .object({
    ...
    tourGuides: zod
      ...
      .min(1, { message: 'Selecione pelo menos 1 guia!' }),
    ...
    services: zod.string().array().min(2, { message: 'Selecione pelo menos 2 serviços!' }),
    tags: zod.string().array().min(2, { message: 'Adicione pelo menos 2 tags!' }),
  })
