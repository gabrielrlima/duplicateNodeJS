...
export function CorretorDetailsToolbar({
  status,
  backHref,
  corretorId,
  createdAt,
      ...
      >
        <Box sx={{ gap: 1, display: 'flex', alignItems: 'flex-start' }}>
          ...
          <Stack spacing={0.5}>
            <Box sx={{ gap: 1, display: 'flex', alignItems: 'center' }}>
              <Typography variant="h4">{corretorName}</Typography>
              <Label
                variant="soft"
                color={
                  (status === 'ativo' && 'success') ||
                  (status === 'suspenso' && 'warning') ||
        ...
        >
          ...
          <Button
            ...
            href={paths.dashboard.corretores.edit(corretorId)}
          >
            Editar
          </Button>
        </Box>
