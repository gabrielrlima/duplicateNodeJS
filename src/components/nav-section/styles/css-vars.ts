...
function colorVars(theme: Theme, variant?: 'vertical' | 'mini' | 'horizontal') {
  ...
  return {
    ...
    '--nav-item-root-active-bg':
      theme.palette.mode === 'dark'
        ? varAlpha(palette.primary.mainChannel, 0.16)
        : varAlpha(palette.primary.mainChannel, 0.08),
    ...
    '--nav-item-sub-active-bg':
      theme.palette.mode === 'dark'
        ? varAlpha(palette.primary.mainChannel, 0.12)
